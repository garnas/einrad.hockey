...
TRUNCATE TABLE abstimmung_ergebnisse;
-- Spieler
UPDATE spieler SET vorname='Vorname', nachname='Nachname', jahrgang=2000, geschlecht ='w', letzte_saison='31', timestamp = NULL;
...
INSERT INTO ligaleitung(funktion, login, passwort, spieler_id, email) VALUES ('team_social_media', 'team_social_media', '$2y$10$ErHYjOnzowhPpBAqWRjOG.YsaaBJiR/IybP.1pdyWt4MBPlKNpN5e', '3', 'test@einrad.hockey');
