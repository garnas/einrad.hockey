...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= new DateTime('2025-12-10 08:00')): ?>
        
        <div class="slide-container">
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/LlIsU10kPC/21.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/LlIsU10kPC/22.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/LlIsU10kPC/23.jpg" />
            </div>

            <?php if ($now >= new DateTime('2025-12-10 22:00')): ?>
                <div class="slideshow">
                    <img class="slide" src="../../../bilder/advent/LlIsU10kPC/24.jpg" />
                </div>
            <?php endif; ?>
