...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= new DateTime('2025-12-11 08:00')): ?>
        
        <div class="slide-container">
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/WKcwjS11Gh/1.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/WKcwjS11Gh/2.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/WKcwjS11Gh/3.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/WKcwjS11Gh/4.jpg" />
            </div>

            <?php if ($now >= new DateTime('2025-12-11 23:59')): ?>
                <div class="slideshow">
                    <img class="slide" src="../../../bilder/advent/WKcwjS11Gh/5.jpg" />
                </div>
            <?php endif; ?>
