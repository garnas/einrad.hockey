...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= new DateTime('2025-12-06 08:00')): ?>
        
        <div class="slide-container">
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/TZpFaMN6tC/1.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/TZpFaMN6tC/2.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/TZpFaMN6tC/3.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/TZpFaMN6tC/4.jpg" />
            </div>
        </div>
