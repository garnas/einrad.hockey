...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= new DateTime('2025-12-08 08:00')): ?>
        
        <div class="slide-container">
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/FhcAK8xnZpx/10.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/FhcAK8xnZpx/11.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/FhcAK8xnZpx/12.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/FhcAK8xnZpx/13.jpg" />
            </div>
        </div>
