...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= new DateTime('2025-12-17 08:00')): ?>
        
        <div class="slide-container">
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/cURhmS17Rv/4.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/cURhmS17Rv/5.jpg" />
            </div>
            <div class="slideshow">
                <img class="slide" src="../../../bilder/advent/cURhmS17Rv/6.jpg" />
            </div>

            <?php if ($now >= new DateTime('2025-12-17 22:00')): ?>
                <div class="slideshow">
                    <img class="slide" src="../../../bilder/advent/cURhmS17Rv/7.jpg" />
                </div>
            <?php endif; ?>
