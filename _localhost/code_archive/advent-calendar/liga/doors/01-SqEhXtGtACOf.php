...
$day_target = new DateTime('2025-12-02');
$time_target = new DateTime('2025-12-01 18:00');
$now = new DateTime();
...
<div class="w3-display-container advent-color w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    <?php if ($now >= $time_target): ?>
      <div class="slide-container">
        <div class="slideshow">
          <img class="slide" src="../../../bilder/advent/SqEhXtGtACOf/1.jpg" />
        </div>
        <div class="slideshow">
          <img class="slide" src="../../../bilder/advent/SqEhXtGtACOf/2.jpg" />
        </div>
        <div class="slideshow">
          <img class="slide" src="../../../bilder/advent/SqEhXtGtACOf/3.jpg" />
        </div>
        <?php if ($now > $day_target):?>
          <div class="slideshow">
            <img class="slide" src="../../../bilder/advent/SqEhXtGtACOf/4.jpg" />
          </div>
        <?php endif; ?>
      </div>
