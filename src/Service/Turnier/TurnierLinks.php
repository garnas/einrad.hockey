...
class TurnierLinks
{
    ...
    public static function getLinksFuerAusrichter(Turnier $turnier): array
    {
        $turnierId = $turnier->id();
        $links[] = Html::link(
            "../liga/turnier_details.php?turnier_id=$turnierId",
            "Turnierdetails",
            icon: "info",
        );
        ...
        if ($turnier->isSpassTurnier()) {
            $links[] = Html::link(
                "../teamcenter/tc_spassturnier_anmeldung.php?turnier_id=$turnierId",
        ...
        if ($turnier->isSpielplanPhase()) {
            $links[] = "<b>"
                . Html::link(
                    "../teamcenter/tc_spielplan.php?turnier_id=$turnierId",
            ...
            $links[] = "<b>"
                . Html::link(
                    "../teamcenter/tc_turnier_report.php?turnier_id=$turnierId",
        ...
        $links[] = Html::link(
            "../teamcenter/tc_quittungen.php?turnier_id=$turnierId",
