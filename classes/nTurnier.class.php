...
class nTurnier
{
     ...
     * @return nTurnier[]
     */
    public static function get_turniere(string $phase, bool $equal = true, bool $asc = true, int $saison = Config::SAISON): array 
    {
        $sql = "
                SELECT turniere_liga.*, turniere_details.*, teams_liga.teamname 
                FROM turniere_liga 
     ...
     * @return array
     */
    public static function get_deleted_turniere(int $saison = Config::SAISON): array
    {
        $sql = "
                SELECT * 
     ...
     * @return nTurnier
     */
    public static function new_turnier(int $ausrichter): nTurnier
    {
        $sql = "
