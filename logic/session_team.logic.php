...
if (!isset($no_redirect) && $daten['ligavertreter'] == ''){
  Form::affirm("Bitte tragt vor der Nutzung des Teamcenters erneut einen Ligavertreter ein, welcher unsere aktualisierten " . Form::link(Config::LINK_DSGVO,"Datenschutz-Hinweise") . " gelesen und akzeptiert hat. Beachtet bitte, dass jedes Team in der Saison " . Saison::get_saison_string() . " nur noch einen Ligavertreter haben kann.");
