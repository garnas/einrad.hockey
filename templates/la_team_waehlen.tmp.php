...
<form class="w3-panel w3-card-4" method="post">
  <p>
    ...
    <input onchange="this.form.submit();" type="text" style="max-width:400px" class="w3-input w3-border w3-border-primary" placeholder="Team eingeben" list="teams" id="la_team_waehlen" name="la_team_waehlen">
      <?=Html::datalist_teams()?>
  </p>
  <p>
