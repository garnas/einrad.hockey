        ...
        <div class="w3-dropdown-hover w3-right w3-text-primary">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-border">
                ...
                <div class="<?=$tc_color ?? ''?>">
                    ...
                    <a class="w3-bar-item w3-button" href="../teamcenter/tc_turnierliste_verwalten.php">Turnier verwalten</a>
                    ...
                    <a class="w3-bar-item w3-button" href="../teamcenter/tc_emails.php">Kontaktcenter</a>
