        ...
        <div class="w3-border w3-border-primary">
            <div class="w3-panel">
                ...
                <p>
                    ...
                    <select style='' class='w3-select w3-border w3-border-primary' id='delete_jpg' name='delete_jpg'>
            ...
            <div class="w3-panel">
                ...
                <p>
                    ...
                    <select style='' class='w3-select w3-border w3-border-primary' id='delete_pdf' name='delete_pdf'>
