        ...
        <footer class="w3-container w3-margin-top w3-center w3-cell-bottom w3-primary">
            <div class="w3-center">
                ...
                <a href="<?=Config::LINK_FACE?>" class="w3-button"><i class="material-icons">group_add</i> Facebook</a>
                <a href="<?=Config::LINK_INSTA?>" class="w3-button"><i class="material-icons">camera_alt</i> Instagram</a>
            </div>
            <div class="w3-center">
