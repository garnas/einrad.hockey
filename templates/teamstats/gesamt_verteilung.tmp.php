...
<div class="w3-row-padding w3-stretch">
    ...
    <div class="w3-quarter">
        <div class="w3-panel w3-primary w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle['games']?></p>
    ...
    <div class="w3-quarter">
        <div class="w3-panel ehl-green w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle['win']?></p>
    ...
    <div class="w3-quarter">
        <div class="w3-panel ehl-yellow w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle['draw']?></p>
    ...
    <div class="w3-quarter">
        <div class="w3-panel ehl-red w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle['loss']?></p>
...
<div class="w3-row-padding w3-stretch">
    ...
    <div class="w3-third">
        <div class="w3-panel w3-primary w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle_tore['goals']?></p>
    ...
    <div class="w3-third">
        <div class="w3-panel w3-primary w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle_tore['goals_against']?></p>
    ...
    <div class="w3-third">
        <div class="w3-panel w3-primary w3-card-4">
            <p class="w3-center w3-xlarge"><?=$alle_tore['diff']?></p>
