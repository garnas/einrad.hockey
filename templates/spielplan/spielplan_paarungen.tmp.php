<div class="w3-hide-small">
    ...
    <?php if($spielplan->akt_turnier->daten['besprechung'] == 'Ja'){?><p class="nicht-drucken"><i>Alle Teams sollen sich um <?=date('H:i', strtotime($spielplan->akt_turnier->daten['startzeit']) - 15*60)?>&nbsp;Uhr zu einer gemeinsamen Turnierbesprechung einfinden.</i></p><?php }//endif?>
