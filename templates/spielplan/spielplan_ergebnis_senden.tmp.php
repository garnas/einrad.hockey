<form method="post">
    ...
    <input type="submit" 
        ...
        value="Ergebnis übermitteln">
    </p>
    <?php if($spielplan->akt_turnier->daten['phase'] == 'ergebnis'){?>
        <p class="w3-text-green"><i class="material-icons">check_circle</i> Dem Ligaausschuss liegt ein Turnierergebnis vor. Durch erneutes Übermitteln kann das Turnierergebnis korrigiert werden.</p>
    <?php }//endif?>
    <?php if($spielplan->akt_turnier->daten['phase'] != 'ergebnis'){?>
