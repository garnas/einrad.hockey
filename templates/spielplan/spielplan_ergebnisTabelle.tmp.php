<div class="w3-hide-small">
   ...
   <div class="w3-responsive w3-card">
        <table class="w3-table <?php if((($teamcenter ?? false) or ($ligacenter ?? false)) && $spielplan->akt_turnier->daten['phase'] == 'ergebnis'){?>w3-pale-green<?php }else{?>w3-striped<?php }//endif?>">
            <tr class="w3-primary">
