<div class="w3-hide-large w3-hide-medium">
    ...
    <div class="w3-responsive w3-card">
        <table class="w3-table <?php if((($teamcenter ?? false) or ($ligacenter ?? false)) && $spielplan->akt_turnier->details['phase'] == 'ergebnis'){?>w3-pale-green<?php }else{?>w3-striped<?php }//endif?>" style="white-space: nowrap;">
            <tr class="w3-primary">
