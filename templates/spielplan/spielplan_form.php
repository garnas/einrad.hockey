...
<form method="post">
    ...
    <p class="w3-hide-large w3-hide-medium">
        <input type="submit"
               name="m_tore_speichern"
               class="w3-block w3-button w3-tertiary"
               value="Spiele zwischenspeichern"></p>
    <!-- Button für Desktop -->
    <p class="w3-hide-small">
        <input type="submit"
               name="d_tore_speichern"
               class="w3-block w3-button w3-tertiary"
        ...
        <table class="w3-table w3-centered w3-striped">
            ...
            <?php foreach ($spielplan->spiele as $spiel_id => $spiel) { ?>
                ...
                >
                        ...
                        <table class="w3-table w3-centered" style="width: auto; margin: auto;">
                            <tr>
                                <td style="width: 30px; padding:0;">
                                    <?php if ($teamcenter or $ligacenter) { ?>
                                        <!-- Input Tore A -->
                                        <input id="d_tore_a[<?= $spiel_id ?>]"
                                               name="d_tore_a[<?= $spiel_id ?>]"
                                               value='<?= $spiel["tore_a"] ?>'
                                ...
                                <td style="width: 30px; padding:0;">
                                    <?php if ($teamcenter or $ligacenter) { ?>
                                        <!-- Input Tore B -->
                                        <input id="d_tore_b[<?= $spiel_id ?>]"
                                               name="d_tore_b[<?= $spiel_id ?>]"
                                               value='<?= $spiel["tore_b"] ?>'
                                               class='w3-input w3-border w3-round w3-center'
                                               style='padding: 2px; width: 65px; display: inline-block;'
                                               type='number'
                    ...
                    <span class="pdf-hide">
                        <?php if ($teamcenter or $ligacenter) { ?>
                            <input id="m_tore_a[<?= $spiel_id ?>]"
                                   name="m_tore_a[<?= $spiel_id ?>]"
                                   value='<?= $spiel["tore_b"] ?>'
                                   class='w3-input w3-border w3-round w3-center'
                                   style='padding: 2px; width: 65px; display: inline-block;'
                                   type='number'
                        ...
                        <span class="pdf-hide">
                        <?php if ($teamcenter or $ligacenter) { ?>
                            <input id="m_tore_b[<?= $spiel_id ?>]"
                                   name="m_tore_b[<?= $spiel_id ?>]"
                                   value='<?= $spiel["tore_b"] ?>'
                                   class='w3-input w3-border w3-round w3-center'
                                   style='padding: 2px; width: 65px; display: inline-block;'
                                   type='number'
                    ...
                    <?php if ($spielplan->check_penalty_anzeigen()) { ?>
                            ...
                            <table class="w3-table w3-centered" style="width: auto; margin: auto;">
                                <tr>
                                    <td class="w3-text-secondary" style="width: 30px; padding:0;">
                                        <?php if ($teamcenter or $ligacenter) { ?>
                                            <input id="d_penalty_a[<?= $spiel_id ?>]"
                                                   name="d_penalty_a[<?= $spiel_id ?>]"
                                    ...
                                    <td class="w3-text-secondary" style="width: 30px; padding:0;">
                                        <?php if ($teamcenter or $ligacenter) { ?>
                                            <input id="d_penalty_b[<?= $spiel_id ?>]"
                                                   name="d_penalty_b[<?= $spiel_id ?>]"
                        ...
                        <span class="pdf-hide w3-text-secondary">
                            <?php if ($teamcenter or $ligacenter) { ?>
                                <!-- Penalty Formular -->
                                <input id="m_penalty_a[<?= $spiel_id ?>]"
                                       name="m_penalty_a[<?= $spiel_id ?>]"
                                       value='<?= $spiel["penalty_a"] ?>'
                                       class='w3-input w3-border w3-round w3-center
                            ...
                            <span class="pdf-hide w3-text-secondary">
                            <?php if ($teamcenter or $ligacenter) { ?>
                                <input id="m_penalty_b[<?= $spiel_id ?>]"
                                       name="m_penalty_b[<?= $spiel_id ?>]"
                                       value='<?= $spiel["penalty_b"] ?>'
                                       class='w3-input w3-border w3-round w3-center
                                       <?= !(!is_null($spiel["penalty_b"])
                                           && !$spielplan->check_penalty_spiel($spiel_id))
    ...
    <!-- Formular für die Ergebniseintragung in den Centern erstellen -->
    <!-- Button für Mobil -->
    <p class="w3-hide-large w3-hide-medium"><input type="submit" name="m_tore_speichern" class="w3-block w3-button w3-tertiary" value="Spiele zwischenspeichern"></p>
    <!-- Button für Desktop -->
    <p class="w3-hide-small"><input type="submit" name="d_tore_speichern" class="w3-block w3-button w3-tertiary" value="Spiele zwischenspeichern"></p>
</form>
<?php } // end if ?>
