...
<form method="post">
    ...
    <!-- Button für Mobil -->
    <p class="w3-hide-large w3-hide-medium">
        <input type="submit" name="m_tore_speichern" class="w3-block w3-button w3-tertiary" value="Spiele zwischenspeichern">
    </p>
    <!-- Button für Desktop -->
    <p class="w3-hide-small">
        <input type="submit" name="d_tore_speichern" class="w3-block w3-button w3-tertiary" value="Spiele zwischenspeichern">
    </p>
</form>
<?php } // end if ?>

<script>
    // Scrollen soll keine Veränderung des Nummernfeldes verursachen
