...
$centerpanels = array(
  ...
  array("name" => "Neuigkeit eintragen", "link" => "lc_neuigkeit_eintragen.php", "farbe" => "w3-tertiary"),
  array("name" => "Neuigkeit bearbeiten", "link" => "../liga/neues.php", "farbe" => "w3-tertiary"),
  array("name" => "Teams-Übersicht", "link" => "lc_teams_uebersicht.php", "farbe" => "w3-green"),
  array("name" => "Team erstellen", "link" => "lc_team_erstellen.php", "farbe" => "w3-green"),
  array("name" => "Teamdaten verwalten", "link" => "lc_teamdaten.php", "farbe" => "w3-green"),
  array("name" => "Teamstrafen", "link" => "lc_teamstrafe.php", "farbe" => "w3-green"),
  array("name" => "Teamkader verwalten", "link" => "lc_kader.php", "farbe" => "w3-green"),
  array("name" => "Spieler verwalten", "link" => "lc_spieler_aendern.php", "farbe" => "w3-green"),
  array("name" => "Passwort ändern", "link" => "lc_pw_aendern.php", "farbe" => "w3-grey"),
  array("name" => "Admin", "link" => "lc_admin.php", "farbe" => "w3-grey"),
  array("name" =>"Logout", "link" => "lc_logout.php", "farbe" => "w3-grey"),
);
