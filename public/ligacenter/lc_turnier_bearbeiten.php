...
<div class="w3-tertiary w3-card-4 w3-panel w3-center">
    <h3><?= TurnierSnippets::ortDatumBlock($turnier) ?></h3>
</div>
<p>
    ...
    <a href='../ligacenter/lc_turnierliste.php?turnier_id=<?=$turnier->id()?>'><button style='display: inline;' class="w3-button w3-right w3-text-primary no">Turniere verwalten (Liste)</button></a>
</p>
