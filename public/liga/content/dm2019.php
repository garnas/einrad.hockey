...
// Layout
Html::$titel = "Deutsche Meisterschaft 2019 | Deutsche Einradhockeyliga";
Html::$content = "Bericht über die Deutsche Meisterschaft 2019 in Wuppertal.";
...
<div class="w3-display-container w3-round-xlarge w3-padding-16" style="margin-top: 16px;">
    ...
    <div class="w3-section" style="line-height: 1.2;">
        <h1>Die wohl organisatorisch aufwendigste Meisterschaft - Throwback Deutsche Meisterschaft 2019</h1>
    </div>

    <div class="w3-section">
        <p style="background-color: lightgrey; padding: 8px 16px;">
