        ...
        <td>
            <div class="w3-tooltip" style="cursor: help;">
                ...
                <span style="white-space: nowrap; position:absolute; left:38px; bottom:8px;" class="w3-text w3-small w3-primary w3-container">
                            ...
                            <?= $spielplan->platzierungstabelle[$spiel["schiri_team_id_a"]]['teamname'] ?? TeamRepository::get()->team($spiel["schiri_team_id_a"])?->getName(27) ?>
                            |
                            <?= $spielplan->platzierungstabelle[$spiel["schiri_team_id_b"]]['teamname'] ?? TeamRepository::get()->team($spiel["schiri_team_id_a"])?->getName(27) ?>
                        </span>
                <!-- Mobil -->
