...
if (isset($_POST['absenden'])) {
    ...
    $time = time() - openssl_decrypt($_POST['no_bot'], 'AES-256-CBC', Env::DATABASE, 0, str_repeat("\0", 16));
...
?>
    ...
    <div class="w3-card w3-panel">
        ...
        <form method="post">
            <input type="hidden"
                   name="no_bot"
                   value="<?= openssl_encrypt(time(), 'AES-256-CBC', Env::DATABASE, 0, str_repeat("\0", 16)) ?>"
            >
            <p>
