...
html,body{font-family:Verdana,sans-serif;font-size:<?=$font_size ?? "12"?>px;line-height:1}html{overflow-x:hidden}
...
.w3-table td,.w3-table th,.w3-table-all td,.w3-table-all th{padding:<?=$padding ?? "3"?> 4px;display:table-cell;vertical-align:middle}
